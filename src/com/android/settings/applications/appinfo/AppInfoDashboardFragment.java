...
public class AppInfoDashboardFragment extends DashboardFragment
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        if (com.android.internal.util.blackiron.BlackironUtils.isPackageInstalled(mContext,"com.android.vending")) {
    ...
    public void onPrepareOptionsMenu(Menu menu) {
        ...
        if (com.android.internal.util.blackiron.BlackironUtils.isPackageInstalled(getContext(),"com.android.vending")) {
